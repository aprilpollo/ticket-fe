...
export const LoaderBarGithub = ({ 
  ...
  return (
    <div className={cn("fixed top-0 z-50 w-full bg-neutral-200 rounded-full h-1 overflow-hidden dark:bg-neutral-800", className)}>
      <motion.div
...
export const LoaderBarYoutube = ({ 
  ...
  return (
    <div className={cn("fixed top-0 z-50 w-full bg-neutral-200 h-1 overflow-hidden dark:bg-neutral-800", className)}>
      <motion.div
...
export const LoaderBarAnimated = ({ 
  className = "",
  color = "bg-blue-500" 
}: { 
  className?: string; 
...
export const LoaderBarIndeterminate = ({ 
  className = "",
  color = "bg-blue-500" 
}: { 
  className?: string; 
...
// Simple loader component for general use
export const Loader = () => {
  return (
